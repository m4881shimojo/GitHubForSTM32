...
/* push_printfのプログラム。GPIO_Interrupt と printf_TeraTermの合成。
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  printf("Hello World in user code 3 ic= %d\r\n",ic);
  }// end of while(1)ですね
  /* USER CODE END 3 */
}
...
/*
		...
		EXIT15_10からの割込みをdisableにする
*/
//		printf("Hello World in interrupt_Handler \r\n");
	}
}
//
